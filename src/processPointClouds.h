...
public:
    ...
    std::vector<std::vector<int>> euclideanCluster(KdTree* tree, float distanceTol, int minSize, int maxSize, typename pcl::PointCloud<PointT>::Ptr cloud);

    void proximity(KdTree* tree, float distanceTol, int pointID, std::vector<bool>& processed, std::vector<int>& cluster, typename pcl::PointCloud<PointT>::Ptr cloud);
